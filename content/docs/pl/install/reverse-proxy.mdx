...
sourceSha256: c0808a4eef45ccf5ba9d6c02407ea2201f305f5b3257e3c0048425a64948cbff
---
...
**Jest stała, bo pomyłka tutaj jest cicha.** Tam, gdzie jedna domena obsługuje
obie połowy, API nie może stać w korzeniu, bo korzeniem jest aplikacja; a
prefiks, który bywa obecny, to prefiks, który każde wdrożenie musi trafić samo.
Pomyl się, a Client zapyta właściwy host o niewłaściwą ścieżkę, a Twoje reverse
proxy odpowie własnym `index.html` aplikacji zamiast błędem. Wartość zapisana w
