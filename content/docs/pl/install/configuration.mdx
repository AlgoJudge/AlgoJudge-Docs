...
sourceSha256: 4d83f576a2e39214fce57a2ddf7b5cd9a91dcab39699c6c0bdd97eb477fc0b77
---
...
| `RUNNER_CACHE_DIR` | `/srv/algojudge/runner-cache` | **bezwzględna ścieżka na hoście**, wspólna dla czterech Runnerów. Każda paczka jest tam pobierana, rozpakowywana i jej checker kompilowany **raz na wszystkie**, pod blokadą; każdy Runner ogranicza to od środka do 10 GiB. Katalog, a nie wolumen nazwany, bo kontener checkera montuje rozpakowaną paczkę prosto stamtąd, a demon rozwiązuje montowanie po ścieżce. **Trzymaj go poza `RUNNER_WORK_DIR`** — zaplanowane sprzątanie usuwa stamtąd katalogi po wieku |
