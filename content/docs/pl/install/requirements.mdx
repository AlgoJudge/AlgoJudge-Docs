...
sourceSha256: 8419e38273117f9ac542a780d132dab4c146d72079dacdde98b5ed2b99474a3e
---
...
**Potrzebują ich oba.** Limit pamięci jest egzekwowany na cgroup mieszczącej
samo zgłoszenie, a tę zakłada shim **wewnątrz kontenera zadania** — drzewo
widoczne przez ten montaż musi więc być zapisywalne przy każdym z backendów. Pod
`cgroupfs` Runner sprawdza to przy starcie: zakłada cgroup, od razu ją usuwa i
**odmawia uruchomienia**, jeżeli mu się nie uda. Pod `systemd` przy starcie nie ma
czego zakładać, więc drzewo bez prawa zapisu wychodzi na jaw dopiero przy
pierwszym ocenianym przebiegu — jako awaria infrastruktury, która mówi, którego
zapisu nie dało się wykonać.
