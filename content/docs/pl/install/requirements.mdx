...
sourceSha256: 0267a9ee7a24f88ad3389bb9c9af5fcefa2b4822c5063982772ab96fab04cddd
---
...
| Szczyt pamięci **ocenianego** przebiegu | `memory.peak` cgroup, w której było zgłoszenie, zakładanej na każdy przebieg | tak samo, tyle że wewnątrz slice'a |
| Szczyt pamięci pozostałych przebiegów | odczyt z `memory.peak` | `memory.peak` zerowany na starcie przebiegu i liczony od tego, co slice już trzymał, co wymaga **Linuksa 6.8** |
...
egzekwowany na cgroup mieszczącej samo zgłoszenie, a tę zakłada Runner — niezależnie
od backendu. Drzewo, do którego nie umie pisać, jest więc **odmową uruchomienia**
w obu przypadkach, sprawdzaną przy starcie, a nie odkrywaną po jednym nieudanym
zadaniu naraz.
