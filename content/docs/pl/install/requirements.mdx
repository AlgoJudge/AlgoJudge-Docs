...
sourceSha256: eebd31286c1f570a72be04cf2974786131c0ccef94ba9b35274283cc83c5b522
---
...
**Podział, który warto zrobić, to jeden Runner na grupę procesorów i jeden tor
na procesor w tej grupie.** Dwa *różne* Runnery na jednym rdzeniu odbierają
sobie jednostki wykonawcze, a program zużywa wtedy więcej czasu procesora na tę
samą pracę — czyli dostaje zły werdykt, a nie wolniejszy.

**Dwa tory na dwóch wątkach jednego rdzenia robią dokładnie to samo i akurat
tego nikt nie sprawdza.** Runner odmawia szerokości, której jego zbiór nie
pokryje po procesorze na tor; czy to osobne rdzenie, ustawiasz sam. Tor na
