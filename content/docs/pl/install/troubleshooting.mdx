...
sourceSha256: 1a19572eeb5bbf95d2c1a1a84c58745cae60ab2b95821b0125ad7d17f016896b
---
...
jest tym, które obsługuje demon. Odkąd usługa Runnera działa jako root, nie może
to już być przyczyną; spotkasz ją jeszcze w instalacji sprzed 2026-09-03 albo
takiej, w której ktoś zmienił `compose.yaml` — wtedy Runner zawodzi przy
...
**Oba sterowniki cgroup działają i żaden nie wymaga przestawiania demona.** Do
2026-09-03 Runner wymagał `cgroupfs`, a `systemd` jest domyślny niemal wszędzie,
więc instalacja z tamtego czasu może nadal mieć wpis `native.cgroupdriver` w
`/etc/docker/daemon.json`. Nie szkodzi.
