...
sourceSha256: 530f0989be9522e84a3570d5fceb5319315588587195318dbb37234c2b46aac7
---
...
`native.cgroupdriver` w `/etc/docker/daemon.json` nie jest ani potrzebny, ani
szkodliwy.
...
wszystkie przebiegi, więc szczyt dla pojedynczego przebiegu bierze się z
wyzerowania `memory.peak` — interfejsu jądra, który pojawił się w **Linuksie
6.8**. O limicie czasu rozstrzyga czas procesora, więc każdy werdykt pozostaje w
mocy.
...
`cgroupfs`, gdzie szczyt pochodzi ze świeżej cgroup na każdy przebieg i nie
wymaga niczego poza Linuksem 5.19.
