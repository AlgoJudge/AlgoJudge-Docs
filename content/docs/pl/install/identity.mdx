...
sourceSha256: 6ac54389f105e663429b1a65d95975debd4c4b0eac808aac596f8ba217b5937c
---
...
1. **Zarejestruj dostawcę** i skopiuj **adres powrotny**, który pokazuje ekran,
   ...
   nie wymyślasz jej.
2. **Napisz mapowanie** — które grupy katalogu stają się którą rolą. Zacznij
   od `deny`, które nie wpuszcza nikogo, kogo mapowanie nie
   nazywa.
...
Reguła mapowania to **wartość** claimu i **nazwa** roli,
