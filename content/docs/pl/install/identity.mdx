...
- **Dostawca nigdy nie przejmuje istniejącego konta po nazwie ani po adresie.**
  Kolidująca nazwa użytkownika dostaje krótki skrót wartości `sub`, a kolidujący adres
...
wczorajszy wkład, trzymałaby kogoś wśród prowadzących na zawsze — wystarczyłoby, żeby
