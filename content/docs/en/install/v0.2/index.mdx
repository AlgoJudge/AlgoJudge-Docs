...
break without asking. [Update and rollback](/en/install/v0.2/update) says how to pin
...
| `external-runner` | `external-runner` | forwards them to an outside archive instead. **Not in the default set** — see [An external judge](/en/install/v0.2/external-runner) |
...
the host needs](/en/install/v0.2/requirements) has the table.
...
| **T3** | `app,data` | [your own reverse proxy](/en/install/v0.2/reverse-proxy) in front |
...
[An external judge](/en/install/v0.2/external-runner) says what it needs and what it
cannot do for you.
...
[Where the Runners keep their bytes](/en/install/v0.2/configuration#where-the-runners-keep-their-bytes).
...
own hostname. [Identity](/en/install/v0.2/identity) is the chapter for choosing and
registering one.
...
| | |
|---|---|
| [What the host needs](/en/install/v0.2/requirements) | Docker, cgroup v2, disk, logs |
| [First install](/en/install/v0.2/first-install) | from an empty directory to a verdict |
| [Pre-configuration](/en/install/v0.2/preconfiguration) | standing one up without clicking through the panel |
| [Identity](/en/install/v0.2/identity) | Keycloak or Authentik, and how to register one |
| [Connecting a course platform](/en/install/v0.2/lti) | LTI 1.3, and the browser setting it turns on |
| [Where the files go](/en/install/v0.2/storage) | the three stores, and moving between them |
| [Maintenance mode](/en/install/v0.2/maintenance) | taking it out of service without stopping it |
| [Backup](/en/install/v0.2/backup) | what a dump covers, and what it carries |
| [Restore](/en/install/v0.2/restore) | putting one back |
| [Update and rollback](/en/install/v0.2/update) | and what a rollback cannot undo |
| [Routine work and the schedule](/en/install/v0.2/schedule) | garbage collection, cron, and what nobody tells you |
| [Your own reverse proxy](/en/install/v0.2/reverse-proxy) | the five rules |
| [An external judge](/en/install/v0.2/external-runner) | forwarding problems to an outside archive |
| [Every setting in `.env`](/en/install/v0.2/configuration) | the whole of it, in one table |
| [When something does not work](/en/install/v0.2/troubleshooting) | the failure modes that look like other problems |
