---
title: Backup
description: What the dump covers, what it carries, and the two bounds that keep a backup directory from becoming the outage.
---
...
a certificate nobody supplies any more fails exactly there. Without asking, the
only symptom is everybody being signed out, after the fact.
</Callout>
...
backup first. [Where the files go](/en/install/v0.1/storage) is the whole of it.
