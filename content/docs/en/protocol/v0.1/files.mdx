...
Server that has forgotten it. [Claiming](/en/protocol/v0.1/claiming) says why.
</Callout>
...
[infrastructure failure, not a verdict](/en/protocol/v0.1/reporting): the submission
...
That is also why [`extra` is bounded at 2 kB](/en/protocol/v0.1/reporting): the small
