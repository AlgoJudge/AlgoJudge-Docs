...
| `AJ_Runner__Tags` | empty | Comma-separated pools. **A seed, honored at the first registration only** — see [Tags and routing](/en/runner/v0.2/routing) |
...
[Isolation](/en/runner/v0.2/isolation) describes. The Runner cuts its set into one
...
is what the release was tested as. [Languages](/en/runner/v0.2/languages) says why the
...
[Isolation](/en/runner/v0.2/isolation) says why.
</Callout>
...
that happens, read [Tags and routing](/en/runner/v0.2/routing) first.
