...
[Forwarding to onlinejudge.org](/en/runner/uva) offers six languages including
Java and Pascal — by forwarding to a service that runs them, not by running them.

## Four images, and a Runner without them judges nothing

| Image key | Default tag | Variable |
|---|---|---|
| GCC | `algojudge/lang-gcc:local` | `AJ_Sandbox__Image__Gcc` |
| Clang | `algojudge/lang-clang:local` | `AJ_Sandbox__Image__Clang` |
| CPython | `algojudge/lang-python:local` | `AJ_Sandbox__Image__Python` |
| PyPy | `algojudge/lang-pypy:local` | `AJ_Sandbox__Image__Pypy` |
