...
*There were three until 2026-09-02. An empty `AJ_Sandbox__CgroupRoot` used to be
honoured, unlike every other `AJ_` variable, and ended all measurement without a
word; it is now treated as unset, and a relative value is refused by name.*
