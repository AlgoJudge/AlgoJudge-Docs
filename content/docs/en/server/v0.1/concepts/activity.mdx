...
owns [series](/en/server/v0.1/concepts/series), [groups](/en/server/v0.1/concepts/group),
questions, attachment rules, and the [grants](/en/server/v0.1/concepts/grant) that
are its membership.
...
An [assignment](/en/server/v0.1/concepts/assignment) may narrow all three. Time and
...
[series](/en/server/v0.1/concepts/series) may override it, and usually should — that
