...
are one transaction, because they were not always: a platform that answered badly
used to burn a single-use code and leave the administrator to ask for another.
