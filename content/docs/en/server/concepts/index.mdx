...
description: The twelve concepts the Server stores, how they hang together, and the five things a reader gets wrong without being told.
---
...
```
Activity ─┬─ Series ── SeriesProblem ─── Submission ─── EvaluationJob ─── Result
          │              │                                   │
...
an **assignment**, not a bare problem — in a `Series` of an `Activity`.
