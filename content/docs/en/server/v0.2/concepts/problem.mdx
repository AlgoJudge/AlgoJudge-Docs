...
[assignment](/en/server/v0.2/concepts/assignment), which is a separate row and where
...
stops the exception from becoming a second authorization system — nothing else gets a
list like this.
...
well-known [`FileReference.Name`](/en/server/v0.2/concepts/file), understood by the
