...
| Concept | One line |
|---|---|
| [Activity](/en/server/v0.2/concepts/activity) | a contest or a course: the outermost container, and the unit of enrollment |
| [Series](/en/server/v0.2/concepts/series) | a group of problems inside an activity — a round, a week, a class |
| [Problem](/en/server/v0.2/concepts/problem) | a library entry, with append-only content versions |
| [Assignment](/en/server/v0.2/concepts/assignment) | `SeriesProblem`: one problem attached to one series, with its own configuration |
| [Submission](/en/server/v0.2/concepts/submission) | what a participant sent. It carries no verdict |
| [Evaluation](/en/server/v0.2/concepts/evaluation) | `EvaluationJob`, one attempt; `Result`, the outcome of one completed attempt |
| [Group](/en/server/v0.2/concepts/group) | `ActivityGroup`: several people competing as one |
| [Grant](/en/server/v0.2/concepts/grant) | what a user may do within a scope — and, in an activity, the membership |
| [User](/en/server/v0.2/concepts/user) | an account, and the sessions it holds |
| [Runner](/en/server/v0.2/concepts/runner) | a registered evaluation worker |
| [File](/en/server/v0.2/concepts/file) | stored bytes, and the references that say what they are for |
